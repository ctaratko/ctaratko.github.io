...
StocksUpdated2 <- read_csv("/Users/christophertaratko/Documents/ctaratko.github.io/StocksUpdated2.csv")
...
#Historical volatility of each company for each year. <br> A simple measure of historical volatility is calculated by finding the standard deviation <br> of the close prices over a time series. In this case we found the standard deviation for <br> each stock for each year and then showed this data on ggplot.
